    ...
    <>
      ...
      <div className="container relative grid gap-10 py-16 lg:grid-cols-[minmax(0,1fr)_360px]">
        <div className="space-y-8">
          {galleryImages.length ? (
            <section>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {galleryImages.map((image, index) => (
                  <div key={image.id} className={index === 0 ? "group relative aspect-[16/10] overflow-hidden rounded-sm border border-white/[0.1] bg-[#061827] shadow-[0_24px_80px_rgba(0,34,54,0.45)] md:col-span-2" : "group relative aspect-[4/3] overflow-hidden rounded-sm border border-white/[0.1] bg-[#061827] shadow-[0_18px_52px_rgba(0,34,54,0.3)]"}>
            ...
            <section>
              ...
              <div className="relative aspect-[16/9] overflow-hidden rounded-sm border border-white/[0.1] bg-[#061827] shadow-[0_24px_80px_rgba(0,34,54,0.45)]">
            ...
            <div className="rounded-sm border border-white/[0.08] bg-[#061827] p-10 text-white/58">Galeria pendiente de carga desde admin.</div>
          )}
        ...
        <aside className="space-y-5 lg:sticky lg:top-24 lg:self-start">
          ...
          <div className="rounded-sm border border-white/[0.08] bg-[#061827] p-6 shadow-[0_24px_80px_rgba(0,34,54,0.28)]">
