            ...
            <div className="min-w-0 space-y-6">
              <div className="grid gap-6 lg:grid-cols-2">
                <section id="experiencias" className="rounded-lg border bg-white p-6 shadow-[0_14px_36px_rgba(1,45,56,0.05)]">
                  <div className="flex items-center justify-between"><h2 className="font-display text-xl font-bold">Experiencia destacada</h2><Link href="#experiencias" className="text-xs font-semibold text-primary">Ver todas</Link></div>
